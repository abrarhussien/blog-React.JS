            ...
            <div className="relative ml-3">
              {!isUser && (
                <div>
                  <Link
                    to="/login"
                    className="relative flex orangebg text-sm rounded-sm px-5 py-2 font-bold text-white  hover:bg-white hover:text-zinc-900"
                  >
                    login
                  </Link>
                </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <img
                      ...
                      src={currentUser?.image? currentUser.image :myImg}
                      alt=""
                    />
                  </button>
                </div>
              ...
              <div
                className={`${profilMenu} absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none`}
                role="menu"
